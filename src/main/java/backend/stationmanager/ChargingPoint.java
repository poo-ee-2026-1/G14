...
// CONEXÃO DE VEÍCULO
    ...
    // Permite conexão mesmo após reserve() desde que não haja veículo já conectado
...
// ENTREGA DE ENERGIA
    ...
    // Entrega energia ao veículo com base no tempo da simulação
    public void deliverEnergy(
        ...
        if (
            ...
            // Garante que não ultrapasse a carga máxima do veículo
            double actualEnergy =
                    Math.min(
                            energy,
                            missingEnergy
